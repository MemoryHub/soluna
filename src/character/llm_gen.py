...
class CharacterLLMGenerator:
    ...
    async def generate_character(self, name: str = None, age: int = None, gender: str = None, occupation: str = None) -> Character:
        """生成人格并审查其自洽性"""
        # 准备初始提示
        initial_task = "生成一个详细的AI角色人格。"
        if name:
...
async def main():
    ...
    try:
        # 生成一个30岁的男性软件工程师角色
        character = await generator.generate_character(name="张三", age=30, gender="男", occupation="软件工程师")
